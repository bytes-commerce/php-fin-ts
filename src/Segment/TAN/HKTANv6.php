...
class HKTANv6 extends BaseSegment implements HKTAN
{
     ...
     * N: sonst
     */
    public ?\BytesCommerce\Segment\Common\Kti $kontoverbindungInternationalAuftraggeber = null;
    ...
    {
        $hktaNv6 = HKTANv6::createEmpty();
        $hktaNv6->tanProzess = HKTAN::TAN_PROZESS_4;
        $hktaNv6->segmentkennung = 'HKIDN';
        return $hktaNv6;
    }
