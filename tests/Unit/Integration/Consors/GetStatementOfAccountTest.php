...
namespace BytesCommerce\Tests\Unit\Integration\Consors;
...
class GetStatementOfAccountTest extends ConsorsIntegrationTestBase
{
     ...
     * @throws \Throwable
     */
    public function testGetStatementOfAccount(): void
    {
        $this->initDialog();

        $this->expectMessage(static::GET_STATEMENT_REQUEST, static::GET_STATEMENT_RESPONSE);
        $getStatementOfAccount = \BytesCommerce\Action\GetStatementOfAccount::create(
            $this->getTestAccount(),
            new \DateTime('2019-06-01'), new \DateTime('2019-09-22')
        );
        $this->fints->execute($getStatementOfAccount);
        $statement = $getStatementOfAccount->getStatement();
     ...
     * @throws \Throwable
     */
    public function testGetStatementOfAccountEmpty(): void
    {
        $this->initDialog();
