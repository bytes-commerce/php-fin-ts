...
namespace BytesCommerce\Tests\Unit\Integration;

use BytesCommerce\Protocol\ServerException;
use BytesCommerce\Tests\Unit\FinTsTestCase;
...
class InitializationErrorTest extends FinTsTestCase
{
     ...
     * @throws \Throwable
     */
    public function testInitializationErrorMissingField(): void
    {
        $this->expectMessage(
     ...
     * @throws \Throwable
     */
    public function testInitializationErrorInvalidSegment(): void
    {
        $this->expectMessage(
            "HNHBK:1:3+000000000145+300+0+1'HKIDN:2:2+280:11223344+9999999999+0+0'HKVVB:3:3+0+0+0+123456789ABCDEF0123456789+1.0'HKTAN:4:6+4+HKIDN'HNHBS:5:1+1'",
