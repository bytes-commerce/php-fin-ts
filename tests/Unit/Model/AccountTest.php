...
class AccountTest extends TestCase
{
    ...
    {
        $account = $this->account->setId('test-id');
    ...
    {
        $account = $this->account->setAccountNumber('1234567890');
        $this->assertSame($this->account, $account);
    }
    ...
    {
        $account = $this->account->setBankCode('70000000');
        $this->assertSame($this->account, $account);
    }
    ...
    {
        $account = $this->account->setIban('DE89370400440532013000');
        $this->assertSame($this->account, $account);
    }
    ...
    {
        $account = $this->account->setCustomerId('customer-123');
        $this->assertSame($this->account, $account);
    }
    ...
    {
        $account = $this->account->setCurrency('EUR');
        $this->assertSame($this->account, $account);
    }
    ...
    {
        $account = $this->account->setAccountOwnerName('Max Mustermann');
        $this->assertSame($this->account, $account);
    }
    ...
    {
        $account = $this->account->setAccountDescription('Girokonto');
        $this->assertSame($this->account, $account);
    }
