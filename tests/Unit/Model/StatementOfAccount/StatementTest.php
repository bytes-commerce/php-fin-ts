...
class StatementTest extends TestCase
{
    ...
    {
        $statement = $this->statement->setStartBalance(1000.50);
    ...
    {
        $statement = $this->statement->setEndBalance(2000.75);
    ...
    {
        $statement = $this->statement->setCreditDebit(Statement::CD_CREDIT);
    ...
    public function testSetAndGetDate(): void
    {
        ...
        $statement = $this->statement->setDate($date);
