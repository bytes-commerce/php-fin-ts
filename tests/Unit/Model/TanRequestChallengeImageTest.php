...
use BytesCommerce\Model\TanRequestChallengeImage;
...
class TanRequestChallengeImageTest extends TestCase
{
    public function testConstructorWithValidImageData(): void
    {
        ...
        $tanRequestChallengeImage = new TanRequestChallengeImage($bin);

        $this->assertSame($mimeType, $tanRequestChallengeImage->getMimeType());
        $this->assertSame($data, $tanRequestChallengeImage->getData());
    }
    ...
    public function testGetMimeTypeReturnsCorrectType(): void
    {
        ...
        $this->assertSame('image/gif', $tanRequestChallengeImage->getMimeType());
    }
    ...
    public function testConstructorWithLargeDataPayload(): void
    {
        ...
        $this->assertSame(1000, strlen($tanRequestChallengeImage->getData()));
    }
}
