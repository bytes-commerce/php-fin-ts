...
namespace BytesCommerce\Tests\Unit\Model\StatementOfHoldings;
...
{
    private StatementOfHoldings $statementOfHoldings;

    protected function setUp(): void
    {
        $this->statementOfHoldings = new StatementOfHoldings();
    }

    public function testGetHoldingsInitiallyEmpty(): void
    {
        $this->assertIsArray($this->statementOfHoldings->getHoldings());
        $this->assertEmpty($this->statementOfHoldings->getHoldings());
    }
    ...
    public function testAddHoldingIncreasesCount(): void
    {
        ...
        $this->statementOfHoldings->addHolding($holding);

        $this->assertCount(1, $this->statementOfHoldings->getHoldings());
    }
    ...
    public function testAddMultipleHoldings(): void
    {
        ...
        $this->statementOfHoldings->addHolding($holding1);
        $this->statementOfHoldings->addHolding($holding2);

        $this->assertCount(2, $this->statementOfHoldings->getHoldings());
    }
    ...
    public function testGetHoldingsReturnsCorrectHolding(): void
    {
        ...
        $holdings = $this->statementOfHoldings->getHoldings();
    ...
    public function testAddHoldingReturnsVoid(): void
    {
        ...
        $result = $this->statementOfHoldings->addHolding($holding);
    ...
    public function testHoldingsArrayIsReference(): void
    {
        ...
        $this->assertSame('Modified', $this->statementOfHoldings->getHoldings()[0]->getName());
    }
}
