...
class HoldingTest extends TestCase
{
    ...
    {
        $holding = $this->holding->setISIN('DE0008404005');
        $this->assertSame($this->holding, $holding);
    }
    ...
    {
        $holding = $this->holding->setWKN('840400');
        $this->assertSame($this->holding, $holding);
    }
    ...
    {
        $holding = $this->holding->setName('Allianz SE');
        $this->assertSame($this->holding, $holding);
    }
    ...
    {
        $holding = $this->holding->setValue(1234.56);
        $this->assertSame($this->holding, $holding);
    }
    ...
    {
        $holding = $this->holding->setPrice(234.50);
        $this->assertSame($this->holding, $holding);
    }
    ...
    {
        $holding = $this->holding->setAcquisitionPrice(200.00);
        $this->assertSame($this->holding, $holding);
    }
    ...
    {
        $holding = $this->holding->setAmount(10.0);
        $this->assertSame($this->holding, $holding);
    }
    ...
    {
        $holding = $this->holding->setCurrency('EUR');
        $this->assertSame($this->holding, $holding);
    }
    ...
    {
        $holding = $this->holding->setDate(new \DateTime('2024-01-15'));
        $this->assertSame($this->holding, $holding);
    }
    ...
    {
        $holding = $this->holding->setTime(new \DateTime('2024-01-15 14:30:00'));
        $this->assertSame($this->holding, $holding);
    }
