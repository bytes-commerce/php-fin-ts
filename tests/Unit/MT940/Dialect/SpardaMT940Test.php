...
{
    private SpardaMT940 $spardaMT940;

    protected function setUp(): void
    {
        $this->spardaMT940 = new SpardaMT940();
    }
    ...
    public function testExtractStructuredDataFromRemittanceLinesWithEmptyInput(): void
    {
        $gvc = '';
        $rawLines = [];
        $result = $this->spardaMT940->extractStructuredDataFromRemittanceLines([], $gvc, $rawLines, []);
    ...
    public function testExtractStructuredDataFromRemittanceLinesWithStructuredData(): void
    {
        ...
        $result = $this->spardaMT940->extractStructuredDataFromRemittanceLines($descriptionLines, $gvc, $rawLines, $transaction);
