...
namespace BytesCommerce\Tests\Unit\Segment\DSE;
...
final class MinimaleVorlaufzeitSEPALastschriftTest extends TestCase
{
    ...
    {
        $minimaleVorlaufzeitSEPALastschrift = MinimaleVorlaufzeitSEPALastschrift::create(5, '130000', 0, 1);

        $this->assertSame(5, $minimaleVorlaufzeitSEPALastschrift->getMinimaleSEPAVorlaufzeit());
        $this->assertSame('130000', $minimaleVorlaufzeitSEPALastschrift->getCutOffZeit());
        $this->assertSame(0, $minimaleVorlaufzeitSEPALastschrift->getUnterstuetzteSEPALastschriftartenCodiert());
        $this->assertSame(1, $minimaleVorlaufzeitSEPALastschrift->getSequenceTypeCodiert());
    }

    public function testCreateWithOnlyRequiredParameters(): void
    {
        $minimaleVorlaufzeitSEPALastschrift = MinimaleVorlaufzeitSEPALastschrift::create(3, '120000', 0, 0);

        $this->assertSame(3, $minimaleVorlaufzeitSEPALastschrift->getMinimaleSEPAVorlaufzeit());
        $this->assertSame('120000', $minimaleVorlaufzeitSEPALastschrift->getCutOffZeit());
    }

    public function testCreateWithDifferentMinTage(): void
    {
        $minimaleVorlaufzeitSEPALastschrift = MinimaleVorlaufzeitSEPALastschrift::create(1, '080000', 0, 0);

        $this->assertSame(1, $minimaleVorlaufzeitSEPALastschrift->getMinimaleSEPAVorlaufzeit());
    }

    public function testCreateWithDifferentCutOffZeit(): void
    {
        $minimaleVorlaufzeitSEPALastschrift = MinimaleVorlaufzeitSEPALastschrift::create(3, '150000', 0, 0);

        $this->assertSame('150000', $minimaleVorlaufzeitSEPALastschrift->getCutOffZeit());
    }
