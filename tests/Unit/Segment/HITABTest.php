...
use BytesCommerce\Segment\TAB\HITABv4;
...
class HITABTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testParseDKB(): void
    {
        ...
        $hitaBv4 = HITABv4::parse(static::REAL_DKB_RESPONSE);
        $liste = $hitaBv4->getTanMediumListe();
