...
class FindRueckmeldungTraitTest extends TestCase
{
    ...
    public function testFindRueckmeldungFound(): void
    {
    ...
    public function testFindRueckmeldungen(): void
    {
    ...
    public function testGetAllRueckmeldungen(): void
    {
        /** @var HIRMGv2 $hirmg */
    ...
    public function testFindRueckmeldungscodesForReferenceSegment(): void
    {
