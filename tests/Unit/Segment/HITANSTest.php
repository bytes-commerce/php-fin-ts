...
use BytesCommerce\Segment\TAN\HITANSv6;
...
class HITANSTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testParseDKBResponseV6(): void
    {
        $hitanSv6 = HITANSv6::parse(static::REAL_DKB_RESPONSE[2]);
        $this->assertEquals(1, $hitanSv6->maximaleAnzahlAuftraege);
        $parsedParams = $hitanSv6->parameterZweiSchrittTanEinreichung;
    ...
    public function testSegmentVersionDetection(): void
    {
    ...
    public function testValidateInvalidSegmentkopf(): void
    {
    ...
    public function testValidateInvalidDeg(): void
    {
        $this->expectException(\InvalidArgumentException::class);
