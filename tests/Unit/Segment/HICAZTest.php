...
class HICAZTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testHICAZparse(): void
    {
        // First example: two  XMLs  seperated by ":" - both are gebuchteUmsaetze
        $hicaZv1 = HICAZv1::parse(
            self::HICAZ_TEST_START .
            '@' . strlen(self::SAMPLE_XML_DOC1) . '@' .
            self::SAMPLE_XML_DOC1 .
            ':' .
            '@' . strlen(self::SAMPLE_XML_DOC2) . '@' .
            self::SAMPLE_XML_DOC2 .
            "'"
        );

        $this->assertEquals([self::SAMPLE_XML_DOC1, self::SAMPLE_XML_DOC2],
            $hicaZv1->getGebuchteUmsaetze());
        ...
        $hicaz2 = HICAZv1::parse(
            ...
            ':@' . strlen(self::SAMPLE_XML_DOC2) . '@' .
            self::SAMPLE_XML_DOC2 .
            '+@' . strlen(self::SAMPLE_XML_DOC3) . '@' .
            self::SAMPLE_XML_DOC3 .
            "'"
        );
        $this->assertEquals([self::SAMPLE_XML_DOC1, self::SAMPLE_XML_DOC2],
            $hicaz2->getGebuchteUmsaetze());
        $this->assertEquals(self::SAMPLE_XML_DOC3,
