...
use BytesCommerce\Segment\HIUPD\HIUPDv6;
...
class UpdSerializationTest extends TestCase
{
    ...
    {
        /** @var HIUPDv6 $baseSegment */
        $baseSegment = Parser::parseSegment(self::HIUPD, HIUPDv6::class);
        $this->assertEquals(self::HIUPD, Serializer::serializeSegment($baseSegment));
    }

    public function testNativePhpSerialization(): void
    {
        /** @var HIUPDv6 $hiupd */
        $hiupd = Parser::parseSegment(self::HIUPD, HIUPDv6::class);
