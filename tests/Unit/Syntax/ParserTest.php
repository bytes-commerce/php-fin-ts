...
{
    public function testSplitEscapedStringEmpty(): void
    {
        $this->assertEquals([], Parser::splitEscapedString('+', ''));
        $this->assertEquals(['', ''], Parser::splitEscapedString('+', '+'));
    }

    public function testSplitEscapedStringWithoutEscaping(): void
    {
    ...
    public function testSplitEscapedStringWithEscaping(): void
    {
    ...
    public function testSplitEscapedStringWithBinaryBlock(): void
    {
    ...
    public function testSplitEscapedStringWithEscapingAndBinaryBlock(): void
    {
    ...
    public function testParseDataElement(): void
    {
    ...
    public function testParseDataElementInvalidInt(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        Parser::parseDataElement('lala', 'int');
    }

    public function testParseDataElementInvalidFloatWrongDecimalSeparator(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        Parser::parseDataElement('15.5', 'float');
    }

    public function testParseDataElementInvalidFloatMultipleDecimalSeparator(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        Parser::parseDataElement('15,5,5', 'float');
    }

    public function testParseDataElementInvalidFloatNoDecimalSeparator(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        Parser::parseDataElement('15', 'float');
    }

    // NOTE: Test coverage of DEGs and Segments is provided by tests in Test\BytesCommerce\Segment.
}
